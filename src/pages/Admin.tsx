...
export default function Admin() {
  ...
  useEffect(() => {
    ...
    // Fetch link logs
    const logsQ = query(collection(db, 'linkLogs'), orderBy('timestamp', 'desc'), limit(100));
        ...
        {activeTab === 'logs' && (
          <div className="max-w-4xl mx-auto space-y-6">
            <div className="flex items-center gap-3">
              ...
              <h2 className="text-xl font-semibold text-white">Link Usage Logs (Last 100)</h2>
            </div>
                      ...
                      <tr key={log.id} className="hover:bg-white/5 transition-colors">
                        ...
                        <td className="px-6 py-4">
                          <span className={cn(
                            ...
                            log.shortenerIndex === 1 ? "bg-blue-400/10 text-blue-400" : "bg-purple-400/10 text-purple-400"
                          )}>
                            Shortener {log.shortenerIndex}
                          </span>
                        </td>
