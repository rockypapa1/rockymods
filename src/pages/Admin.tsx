...
export default function Admin() {
  ...
  useEffect(() => {
    const unsubscribe = onAuthStateChanged(auth, (user) => {
      const allowedEmails = ['admin@rockymods.com', 'nxxoteam@gmail.com'];
  ...
  const login = async (e: React.FormEvent) => {
    ...
    const adminEmail = 'nxxoteam@gmail.com'; // Primary admin email
      ...
      <div className="min-h-screen flex items-center justify-center p-4 bg-[#0a0a0a]">
        ...
        >
            <div className="flex flex-col items-center mb-8">
              ...
              <p className="text-zinc-400 text-sm mt-2">Logged in as: <span className="text-indigo-400">{auth.currentUser?.email}</span></p>
            </div>
